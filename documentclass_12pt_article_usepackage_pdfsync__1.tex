...
$\mathbf{n}${n}(s,t) exerted by the material of [s,1] on that of [0,s). $\mathbf{n}$(s,t) is assumed to lie to the ($\mathbf{e}$_1,$\mathbf{n}${e}_2})-plane, so that it has the form
