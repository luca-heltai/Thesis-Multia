...
\begin{equation}
\begin{split}
\rho S\mathbf{r}_{tt} &= \rho S (\mathbf{r}_s)_{tt}\\
                      ...
                      &= \rho S (\nu_{tt}\mathbf{a} + 2\nu_t(\theta_t\mathbf{b}) + \nu(\theta_{tt}\mathbf{b}-\nu\theta_t^2\mathbf{a}) + \eta_{tt}\mathbf{b} + 2\eta_t(-\theta_t\mathbf{a}) + \eta(-\theta_{tt}\mathbf{a}-\eta\theta_t^2\mathbf{b}))\\
                      &= \rho S (\nu_{tt}\mathbf{a} + 2\nu_t\theta_t\mathbf{b} + \nu\theta_{tt}\mathbf{b}-\nu\theta_t^2\mathbf{a}) + \eta_{tt}\mathbf{b} - 2\teta_t\eta_t\mathbf{a}) - \eta\theta_{tt}\mathbf{a}-\nu\theta_t^2\mathbf{b})\\
                      &= \rho S (\left[ (\nu_{tt}-\nu\theta_t^2 - 2\theta_t\nu_t -\eta\theta_{tt})\mathbf{a} + (\nu\theta_{tt}+2\theta_t\nu_t + \eta_{tt}-\eta\theta_t^2)\mathbf{b} \right])
