...
\end{split}
\end{equation}
Doing the same for $(\rhoS\mathbf{r}_{tt})_s$ exploiting the fact that $\mathbf{a}_t =\theta_t\mathbf{b}, \mathbf{b}_t=-\theta_t\mathbf{a}$ and $\mathbf{a}_{tt}=\theta_{tt}\mathbf{b}-\theta_t^2\mathbf{a}, \mathbf{b}_{tt}=-\theta_{tt}\mathbf{a}-\theta_t^2\mathbf{b}$ yields
