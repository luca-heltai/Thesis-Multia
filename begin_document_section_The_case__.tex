...
The elastica theory that stays behind our framework is based on these two constraints and on the constitutive equation M is linear in the change in $\mu$ :
M(s) = (EI)(s)[μ(s) − μ◦(s)].
