...
\]
where \alpha = \alpha(s,t) is the spontaneous curvature, \nu = \nu(s,t) describes the stretch, \eta = \eta(s,t) defines the shear strain and {\cA}, {\cB}, {\cC} represent respectively the the stretch stiffness, the bending stiffness, the shear stiffness
\\
and the internal energy dissipation density as 
\[ \mathcal{D}_{diss}(\mathbf{y}_t) = \frac{A}{2}\mid\mu_t\mid^2 + \frac{A}{2}\mid\eta_t\mid^2
+ \frac{A}{2}\mid\nu_t\mid^2.
\]
\end{document}
