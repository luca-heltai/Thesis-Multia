...
2 \textbf{Background on the special Cosserat model}\\\\
3 \textbf{Some highlights of Hamilton’s Principle}\\\\
4 \textbf{Beck’s column immersed in a viscous fluid}\\\\
...
5 \textbf{The case of the inextensible and unshearable Beck’s Column}\\\\
$\,\,\,\,$5.1 Governing equations\\
$\,\,\,\,$5.2 Stability Analysis and Hopf Bifurcation\\
6 \textbf{Numerical tests}\\\\
7 \textbf{Discussion and future work}\\
\\\\
