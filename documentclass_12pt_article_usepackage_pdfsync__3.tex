...
\\\\
In Section 1, we model it as an extensional shearable rod and we explore its planar, nonlinear dynamics by using the simple Cosserat model. 
...
In Section 2 we explicitly derive, through a generalization of Hamilton's Variational Principle, the equations of motion 
