...
\begin{document}
\section{Abstract}
Beck's column is a classical problem of structural mechanics, where a cantilever column is clamped on one end and it is subject to a compressive follower force. Beck's column is one of the simplest mechanical models which presents a Hopf's bifurcation when the follower load exceeds a critical value. 
