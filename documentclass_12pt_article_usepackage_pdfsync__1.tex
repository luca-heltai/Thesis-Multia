...
This formulation takes into account that we are dealing with a viscoelastic medium that has the ability to actively modify its spontaneous curvature, that is extensible and shearable.
\\\\
