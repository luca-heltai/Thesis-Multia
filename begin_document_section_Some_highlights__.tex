...
\\
\par Thus far it has been assumed that the generalized coordinates $\mathbf{q}_k$ are independent. Suppose instead that they are required to satisfy prescribed equations 
