...
\\\\
\emph{In Jülicher abbiamo $\eta$ = - B$(\theta_s - \alpha)_s$, che è l'equazione che mi da $\eta$, ovvero la componente della forza lungo la direzione normale ($"\mathbf{b}"$), ed è derivata rispetto ad s per il motivo che ho elencato sopra.}
\\\\
\emph{Noi abbiamo $\hat{M}$ = C($\theta$_s - $\alpha$), che è l'equazione lungo M e non è derivata rispetto ad s.}
\\\\
