...
Chen analyzed the problem of dynamic stability for Beck’s column, showing that equilibrium ca be lost by Hopf Bifurcation and that viscosity can cause destabilization. 
...
\\\\
We model it as an extensional shearable rod and we explore its planar, nonlinear dynamics by using the simple Cosserat model. 
\\\\
