...
If the system is subject to conservative forces, then its potential energy $\mathcal{U}$ can be expressed as a function of the generalized coordinates, \mathcal{U}=\mathcal{U}(\mathbf{q}_k). Each of the second partial derivatives of $\mathcal{T}$ and each of the first partial derivatives of $\mathcal{U}$ will be assumed to exist and to be continuous.
We define the Lagrangian of the system
