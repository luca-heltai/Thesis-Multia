...
\mathbf{a}_{ss}& = -\theta_{ss}\mathbf{a}+\theta_s\mathbf{b}_s & &=
\mathbf{b}_{ss}& = \theta_{ss}\mathbf{b}+\theta_s\mathbf{a}_s\\
               & = \theta_{ss}\mathbf{b} - \theta_s\theta_s\mathbf{a} & &= -\theta_{ss}\mathbf{a}
\end{align}
