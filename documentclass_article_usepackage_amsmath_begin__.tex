...
\section{Componential form of the equations of motion}\label{componential-form-of-the-equations-of-motion}
...
\begin{align}
M &= [C(\theta_s -\alpha)]_s + \tilde{C}(\theta_s)_t\\
N &= [A(\nu - 1)]_s + \tilde{A}\nu_t\\
H &= (B\eta)_s + \tilde{B}\eta_t
\end{align}
...
&= 0\\
M - [C(\theta_s -\alpha)]_s - \tilde{C}(\theta_s)_t &= 0\\
N - [A(\nu - 1)]_s - \tilde{A}\nu_t &= 0\\
H - (B\eta)_s - \tilde{B}\eta_t &= 0
\end{align}
