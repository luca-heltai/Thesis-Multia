...
\[ \mathcal{D}_{fluid}(\mathbf{y}_t)= -(\xi_\parallel\left|\mathbf{r}_t\cdot\mathbf{a}\right|^2 + \xi_\perp \left|\mathbf{r}_t\cdot\mathbf{n}\right|^2),
\]

\[\mathbf{Q}_{fluid} = -( \xi_\parallel (\mathbf{r}_t\otimes\mathbf{a})\mathbf{a} + \xi_\perp (\mathbf{r}_t\otimes\mathbf{n})\mathbf{n}),
\]
