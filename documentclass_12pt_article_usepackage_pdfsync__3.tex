...
Chen analysed the problem of dynamic stability for Beck’s column 

The column, usually referred to as Beek's column, is clamped at one end and is subject to a follower force of constant intensity at the  free end. We model it as an extensional shearable rod and we explore its planar, nonlinear dynamics by using the simple Cosserat model. 
