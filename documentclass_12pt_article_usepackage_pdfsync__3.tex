...
\usepackage[draft,inline,marginclue,mode=multiuser]{fixme}

\FXRegisterAuthor{ads}{aads}{ADS}
\FXRegisterAuthor{lh}{alh}{LH}
\FXRegisterAuthor{om}{aom}{OM}

\newcommand{\ADS}[1]{\adswarning{#1}}
\newcommand{\OM}[1]{\omwarning{#1}}
\newcommand{\LH}[1]{\lhwarning{#1}}
...
\\\\
\textbf{Contents}\\\\
\textbf{1  Introduction - Literature review}\\\\
