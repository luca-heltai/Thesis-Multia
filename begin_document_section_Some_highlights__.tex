...
\\\\
Let it be assumed that the kinetic energy of the system, $\mathcal{T}$, can be expressed as a function of the generalized coordinates and their time derivatives, $\mathcal{T} = \mathcal{T}(\mathbf{q}_k,\dot{\mathbf{q}}_k)$. This expression indicates that $\mathcal{T}$ may be a function of $\mathbf{q}$_k and $\dot{\mathbf{q}}$_k for each value of k from 1 to K.
...
\[ "Among\;admissible\;motions,\;the\;actual\;motion\;of\;a\;system\;is\;such\;that\\
