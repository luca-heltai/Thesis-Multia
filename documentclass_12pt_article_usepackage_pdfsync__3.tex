...
\begin{document}
\section{Abstract}
In 1986 M.Chen analyzed the problem of dynamic stability for Beck’s column, showing that equilibrium can be lost by Hopf Bifurcation and that viscosity can cause destabilization. 
