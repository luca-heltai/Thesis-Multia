...
cross–section plane.
Throughout this work, we denote three–dimensional Euclidean space by ($\mathbb{E}$, ⟨ · , · ⟩) and choose a fixed right–handed orthonormal triple ($\mathbf{e}_1, \mathbf{e}_2, \mathbf{e}_3$) of basis vectors.
